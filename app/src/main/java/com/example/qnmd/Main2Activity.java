...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3=(Button)findViewById(R.id.LecturerRating);
        button4=(Button)findViewById(R.id.broadCast);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent=new Intent(Main2Activity.this,LecturerRating.class);
                intent.putExtra("classname",className);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent=new Intent(Main2Activity.this,BroadcastList.class);
                intent.putExtra("classname",className);
